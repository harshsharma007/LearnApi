    ...
    */
    public class ParameterBindingController : ApiController
    {
        ...
        */
        ...
        {
            /*
                As you can see above, Get method includes multiple primitive type parameters. So, Web API will try to extract the values from the query string of
                requested URL.
        ...
        */
        ...
        {
            /*
                The above Post() method includes Student type parameter. So, as a default rule, Web API will try to get the values of student parameter from HTTP request body.
