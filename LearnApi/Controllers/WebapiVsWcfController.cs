...
namespace LearnApi.Controllers
{
    ...
    public class WebapiVsWcfController : ApiController //Without using HTTP verbs.
    {
        ...
        {
            //To pass value to this method, the type selected must be "Get" and in postman body "raw" should be selected as an option and the request must be
            //send in JSON format only.
            //Sample format of request
            //{
            //  "value" : "Harsh"
            ...
            //As in above example
            //"value" is used, not the variable "name".
        }

        public void Put(int id, [FromBody] string value)
        {
            //To pass value to this method, the type selected must be "Put" and in postman body "raw" should be selected as an option and the request must be
            //send in JSON format only.
            //Sample format of request
